...
#include <HexRef/Top/HexRefTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    HexRef::setupTopology(inputs);
    HexRef::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    HexRef::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
