// ======================================================================
// \title  HexRefTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef HEXREF_HEXREFTOPOLOGY_HPP
#define HEXREF_HEXREFTOPOLOGY_HPP
// Included for access to HexRef::TopologyState and HexRef::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <HexRef/Top/HexRefTopologyDefs.hpp>

// Remove unnecessary HexRef:: qualifications
using namespace HexRef;
namespace HexRef {
/**
 ...
 * HexRef::TopologyState see: HexRefTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type HexRef::TopologyState see: HexRefTopologyDefs.hpp.
 *
