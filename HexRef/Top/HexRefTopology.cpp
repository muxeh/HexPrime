// ======================================================================
// \title  HexRefTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <HexRef/Top/HexRefTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <HexRef/Top/HexRefPacketsAc.hpp>
...
// Public functions for use in main program are namespaced with deployment name HexRef
namespace HexRef {
